...
<head>
    ...
    <title>404 Page | <?=getenv('app_name')?></title>
    ...
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/bootstrap.min.css">
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/font-awesome.min.css">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/owl.carousel.css">
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/owl.theme.css">
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/owl.transitions.css">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/animate.css">
    <!-- normalize CSS
		============================================ -->
    ...
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/calendar/fullcalendar.print.min.css">
    <!-- style CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/style.css">
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="<?=base_url()?>/assets/theme/kiaalap-master/css/responsive.css">
    <!-- modernizr JS
		============================================ -->
    <script src="<?=base_url()?>/assets/theme/kiaalap-master/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
    ...
    <div class="error-pagewrap">
		<div class="error-page-int">
			<div class="content-error">
				...
				<a href="i<?=base_url();?>">Dashboard</a>
				<a href="#">Report Problem</a>
			</div>
			<div class="text-center login-footer">
				<p>Copyright © 2024. All rights reserved. Template by <a href="<?=base_url()?>"><?=getenv('owner')?></a></p>
			</div>
		</div>
    </div>
    <!-- jquery
		============================================ -->
    <script src="<?=base_url()?>/assets/theme/kiaalap-master/js/vendor/jquery-1.12.4.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
