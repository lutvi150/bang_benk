                                    ...
                                    <div class="all-form-element-inner">
                                        <form action="#" id="form-produk">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        <label class="login2 pull-right-pro">Satuan Produk</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" name="satuan_produk" value="<?= $produk->satuan_produk ?>" class="form-control" />
                                                        <span class="text-error e_satuan_produk"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
