   <!-- jquery
    ...
    <!-- icheck JS
		============================================ -->
    <script src="<?=base_url()?>/assets/theme/kiaalap-master/js/icheck/icheck.min.js"></script>
    <script src="<?=base_url()?>/assets/theme/kiaalap-master/js/icheck/icheck-active.js"></script>
    <!-- plugins JS
		============================================ -->
